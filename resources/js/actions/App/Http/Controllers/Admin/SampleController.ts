...
/**
* @see \App\Http\Controllers\Admin\SampleController::toggleFeatured
* @see app/Http/Controllers/Admin/SampleController.php:84
* @route '/admin/sample/{id}/toggle-featured'
*/
...
toggleFeatured.definition = {
    methods: ["post"],
    url: '/admin/sample/{id}/toggle-featured',
...
* @see app/Http/Controllers/Admin/SampleController.php:27
* @route '/admin/sample'
*/
...
* @see app/Http/Controllers/Admin/SampleController.php:39
...
* @see app/Http/Controllers/Admin/SampleController.php:68
...
* @see app/Http/Controllers/Admin/SampleController.php:56
...
* @see app/Http/Controllers/Admin/SampleController.php:76
* @route '/admin/sample/{sample}'
*/
...
const SampleController = { toggleFeatured, index, create, store, edit, update, destroy }
