...
* @see app/Http/Controllers/Admin/VoiceController.php:106
...
* @see app/Http/Controllers/Admin/VoiceController.php:31
...
* @see app/Http/Controllers/Admin/VoiceController.php:75
* @route '/admin/voice'
*/
...
* @see app/Http/Controllers/Admin/VoiceController.php:91
...
* @see app/Http/Controllers/Admin/VoiceController.php:83
* @route '/admin/voice/{voice}'
*/
...
* @see app/Http/Controllers/Admin/VoiceController.php:99
* @route '/admin/voice/{voice}'
*/
