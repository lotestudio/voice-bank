...
* @see app/Http/Controllers/Admin/OrderController.php:18
* @route '/admin/order'
*/
...
* @see app/Http/Controllers/Admin/OrderController.php:27
...
* @see app/Http/Controllers/Admin/OrderController.php:32
* @route '/admin/order'
*/
...
* @see app/Http/Controllers/Admin/OrderController.php:55
* @route '/admin/order/{order}'
*/
