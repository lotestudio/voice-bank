...
/**
* @see \App\Http\Controllers\Admin\VoiceController::toggleStatus
* @see app/Http/Controllers/Admin/VoiceController.php:143
* @route '/admin/voice/{id}/toggle-status'
*/
...
toggleStatus.definition = {
    methods: ["post"],
    url: '/admin/voice/{id}/toggle-status',
...
* @see app/Http/Controllers/Admin/VoiceController.php:27
* @route '/admin/voice'
*/
...
* @see app/Http/Controllers/Admin/VoiceController.php:112
...
* @see app/Http/Controllers/Admin/VoiceController.php:104
* @route '/admin/voice'
*/
...
* @see app/Http/Controllers/Admin/VoiceController.php:68
...
* @see app/Http/Controllers/Admin/VoiceController.php:127
...
* @see app/Http/Controllers/Admin/VoiceController.php:119
* @route '/admin/voice/{voice}'
*/
...
* @see app/Http/Controllers/Admin/VoiceController.php:135
* @route '/admin/voice/{voice}'
*/
...
const VoiceController = { toggleStatus, index, create, store, show, edit, update, destroy }
