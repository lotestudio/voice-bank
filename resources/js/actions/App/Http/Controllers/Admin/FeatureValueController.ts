...
* @see app/Http/Controllers/Admin/FeatureValueController.php:17
...
* @see app/Http/Controllers/Admin/FeatureValueController.php:28
...
* @see app/Http/Controllers/Admin/FeatureValueController.php:35
* @route '/admin/feature-value'
*/
...
* @see app/Http/Controllers/Admin/FeatureValueController.php:51
...
* @see app/Http/Controllers/Admin/FeatureValueController.php:43
...
* @see app/Http/Controllers/Admin/FeatureValueController.php:59
* @route '/admin/feature-value/{feature_value}'
*/
...
const FeatureValueController = { index, create, store, edit, update, destroy }

export default FeatureValueController