...
* @see app/Http/Controllers/Admin/PostController.php:21
* @route '/admin/post'
*/
...
* @see app/Http/Controllers/Admin/PostController.php:35
* @route '/admin/post'
*/
...
* @see app/Http/Controllers/Admin/PostController.php:51
...
* @see app/Http/Controllers/Admin/PostController.php:58
* @route '/admin/post/{post}'
*/
