...
* @see app/Http/Controllers/Admin/ReviewController.php:16
* @route '/admin/review'
*/
...
* @see app/Http/Controllers/Admin/ReviewController.php:25
...
* @see app/Http/Controllers/Admin/ReviewController.php:38
...
* @see app/Http/Controllers/Admin/ReviewController.php:53
* @route '/admin/review/{review}'
*/
...
const ReviewController = { index, create, store, edit, update, destroy }
